...
namespace SLApps.Pages.Reservations
{
    public class DeleteModel : PageModel
    {
        ...
        public void OnGet(int id_reservation)
        {
            Reservation = _unitOfWork.Reservation.GetFirstOrDefault(u => u.id_reservation == id_reservation);
        ...
        public async Task<IActionResult> OnPost(int id_reservation)
        {


            if (ModelState.IsValid)
            {
                var reservationFromContext = _unitOfWork.Reservation.GetFirstOrDefault(u => u.id_reservation == id_reservation);
                _unitOfWork.Reservation.Remove(reservationFromContext);
                _unitOfWork.Save();
                TempData["success"] = "La reservation a été supprimé avec succès.";
